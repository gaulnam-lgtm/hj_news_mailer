...
<!-- ══ 헤더 + 통계 바 통합 ══ -->
  <tr>
    <td style="background:
    radial-gradient(ellipse at 18% 55%, rgba(99, 102, 241, 0.28) 0%, transparent 52%),
    radial-gradient(ellipse at 82% 18%, rgba(0, 212, 255, 0.20) 0%, transparent 46%),
    radial-gradient(ellipse at 52% 95%, rgba(168, 85, 247, 0.22) 0%, transparent 48%),
    linear-gradient(135deg, #f3f7ff 0%, #e5efff 48%, #eedcff 100%);
  padding: 0;">
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
